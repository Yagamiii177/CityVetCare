...
import NewClinic from "../../components/ClinicRegistration/ClinicList/NewClinic";
import ViewClinic from "../../components/ClinicRegistration/ClinicList/ViewClinic";
import InactiveClinic from "../../components/ClinicRegistration/ClinicList/InactiveClinic";
...
const ClinicManagement = () => {
  ...
  const [viewMode, setViewMode] = useState("pending"); // 'all', 'pending', 'approved', 'inactive'
