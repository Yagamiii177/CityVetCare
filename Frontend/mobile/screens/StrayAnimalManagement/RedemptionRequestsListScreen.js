...
const RedemptionRequestsListScreen = () => {
  ...
  const loadRequests = async () => {
    try {
      ...
      const response = await api.redemptionRequests.listByOwner(ownerId);
  ...
  const renderRequestCard = (request) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() =>
          navigation.navigate("RedemptionRequestDetail", { request })
        }
      >
    ...
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerTitle}>My Redemption Requests</Text>
          <View style={{ width: 24 }} />
        </View>
          ...
          {requests.length > 0 ? (
            ...
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptySubtext}>
                Submit a redemption form to see it here
              </Text>
            </View>
          )}
        </ScrollView>
...
export default RedemptionRequestsListScreen;
