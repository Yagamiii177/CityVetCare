-- Update stored procedures for mobile report management fields
-- Date: 2026-01-04 (Priority feature removed)
...
-- ========================================
-- CREATE INCIDENT - Updated with mobile fields (no priority)
-- ========================================
DELIMITER //
...
-- ========================================
-- UPDATE INCIDENT - Updated with mobile fields (no priority)
-- ========================================
DELIMITER //
...
SELECT 'Stored procedures updated successfully with mobile report fields (priority removed)' as Status;
